...
public class VerificationProcessor2 implements VerificationProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(VerificationProcessor2.class);
